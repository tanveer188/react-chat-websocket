...
export function Signup({ className, ...props }: LoginFormProps) {
    ...
    return (
        <form className={cn("flex flex-col gap-6", className)} {...props}>
            <div className="flex flex-col items-center gap-2 text-center">
                <h1 className="text-2xl font-bold">User create to your account</h1>
            ...
            <div className="grid gap-6">
                <div className="grid gap-2">
                    ...
                    <Input id="username" type="text" value={username} onChange={(e) => setusername(e.target.value)} placeholder="username123" required />
                </div>
                <div className="grid gap-2">
            ...
            <div className="text-center text-sm">
                ...
                <a onClick={()=>{window.location.href="/login"}} href="#" className="underline underline-offset-4">
                    Sign in
                </a>
            </div>
        </form>
